...
|      **`Shift + E`**      | Save the current work a '.zoomme' file, so you can later restore the state of the program. It is going to be save in the same path and with the same name that the image of the screenshot. The computer will *beep* if the file was correctly saved                                                                                                                                                         |
